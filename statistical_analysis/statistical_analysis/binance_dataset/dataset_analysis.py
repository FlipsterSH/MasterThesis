...
high_thresh = 0.0 # threshold for counting high values
low_thresh = -0.0 # threshold for counting low values

dataframe = pd.read_csv("statistical_analysis/binance_dataset/test_dataset.csv", index_col=False)
