...
# test_data_frame = pd.read_csv("MasterThesisMethods/Method1/LTC_high_labeled_dataset_M1.csv", header=0, skiprows=(range(1, 56501)))
...
# # # ####### Loading predictor
predictor = TabularPredictor.load("AutogluonModels/model1_2")
