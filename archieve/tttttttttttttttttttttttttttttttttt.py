...
if __name__ == "__main__":
    start = "1718316000" #14.06.2024
    #start = "1514761200" #01.01.2018
    periods = 5 # 78 # number of 30 day periods
    ...
    labeled_dataset = create_labeled_dataset(concatenated_data, tickers, options, value="BNBUSDC:high", epochs=3, threshold=0.5)
    print(labeled_dataset)
    print(len(labeled_dataset.keys()))
    labeled_dataset.to_csv("validation_set.csv")
