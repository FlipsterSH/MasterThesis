...
import pandas as pd
from testing_folder.supporting_functionsM2 import *
...
def download_and_preprocess_data(ticker, periods, start):
    ...
    processed_data.to_csv("Test11111.csv")
...
#     for i in range(len(dataframe[time]) - epochs): #looping from the third element to the third last element, with stepsize 1, if epoch=3
#         data_row = []
...
if __name__ == "__main__":
    ...
    # # concatenated_data.to_csv("MasterThesisMethods/Method1/test_dataset.csv")
